...
import {Row, Col,Typography, Card, Avatar,List,Button,message,Statistic,Switch} from 'antd';
import { CloseOutlined, CheckOutlined, SettingOutlined,getTwoToneColor,setTwoToneColor,ArrowUpOutlined  } from '@ant-design/icons';
